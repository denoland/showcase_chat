    ...
    <form onSubmit={async (e) => {
      ...
      <label>
        <div class={tw`mb-2.5`}>
          ...
          <p class={tw`font-medium text-xs text-gray-500`}>The name of the chat room.</p>
        </div>
        <input
      ...
      <button class={tw`mt-7 flex flex items-center rounded-md h-8 py-2 px-4 bg-gray-800 font-medium text-sm text-white`} type="submit">
        create
      </button>
    </form>
  );

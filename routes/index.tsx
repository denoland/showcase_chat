          ...
          {data ? (
            ...
            >
              <li>
                <a
                  href="/new"
                  class={tw`flex justify-center items-center bg-white rounded-full h-18 border-2 border-gray-300`}
                >
                  <div
                ...
                return (
                  <li key={room.roomId}>
                    <a
                      ...
                      class={tw`grid grid-cols-3 items-center bg-white rounded-full h-18 border-2 border-gray-300`}
                    >
                      <div />
                      <p
                        class={tw`text-xl font-bold text-gray-900 justify-self-center`}
                      >
                        {room.name}
                      </p>
                      <p
